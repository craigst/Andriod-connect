...
def generate_timesheet():
    ...
    try:
        ...
        # Build JSON data for timesheet script
        json_data = {
            'data': [convert_for_script(j) for j in filtered_jobs]
        }
...
def download_paperwork(filename):
    ...
    try:
        ...
        # If filename is just a load number, search for it
